...
def set_transform_aggregation(soap_out, encoder_decoder, property_predictor):
    ...
    output = property_predictor.predictor[0](output)
    output = property_predictor.predictor[1](output)
    output = property_predictor.predictor[2](output)
